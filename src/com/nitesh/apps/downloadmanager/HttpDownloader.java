			...
			if (mState == DOWNLOADING) {
				...
				if (mListDownloadThread.size() == 0) {
					if (mFileSize > MIN_DOWNLOAD_SIZE) {
						...
						HttpDownloadThread aThread = new HttpDownloadThread(1, mURL, mOutputFolder + mFileName,
								startByte, endByte);
						...
						HttpDownloadThread aThread = new HttpDownloadThread(1, mURL, mOutputFolder + mFileName, 0,
								mFileSize);
						mListDownloadThread.add(aThread);
					}
